   ...
   render(){
     ...
     if(!this.state.isHover){
       ...
       output = (
           ...
           <img src={ this.props.dataElmnt['images']['480w_still']['url'] } className="img-fluid mx-auto d-block image-thumb gif-cell"/>
       ...
       output = (
         <div className="embed-responsive embed-responsive-16by9 animated fadeIn fast gif-cell">
             <iframe src={this.props.dataElmnt.embed_url} width="480" height="270" frameBorder="0" className="giphy-embed embed-responsive-item" allowFullScreen></iframe>
         </div>
       );
    }
